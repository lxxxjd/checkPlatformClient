...
class CostListDetailReviewBack extends PureComponent {
  state = {
    list:{},
    dataSource:[],
  };
  ...
  init =()=>{
    ...
    const listView = JSON.parse(sessionStorage.getItem("CostListDetailReviewBack_costlist"));
...
export default CostListDetailReviewBack;
