      ...
      <Row>
        ...
        <Col span={11}>
          ...
          <span style={{paddingTop:500}}>
            ...
            （1）委托人网上委托后的系统发提醒短信给业务经理；<br />
            （2）接受委托后，短信提醒给“操作经理”，以便安排检验人员；<br />
            （3）总经理，业务副总角色可以撤销委托；<br />
            （4）总经理，业务副总，经理角色指派相应的人员任务；<br />
            （5）总经理、业务副总、实验室主任可以审核检测结果。<br />
            （6）总经理、业务副总、业务经理角色可以发布证书；<br />
            （7）总经理、业务副总、业务经理角色可以审核收费清单；<br />
            （8）总经理、财务副总、财务经理角色可以开具发票，收费到账，审核成本清单，成本支付；<br />
            （9）管理员、总经理角色可以修改字典管理和公司管理内的信息。<br />
            （10）授权签字人，在是否授权签字选“是”，并在角色加选中选择授权签字人
